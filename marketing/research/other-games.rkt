...
(plot (list (discrete-histogram
               '(#(Vanguard-of-War 20) #(Era-of-Kingdoms 8) #(Reign-Ed.2 35)
                 ...
                 #(Darkness-Incarnate 50) #(Absolutism-Surviving-Dictatorship 15) #(STARTROPOLIS 10)
                 #(Miremarsh 58.8))
               #:skip 2 #:x-min 0
               #:label "$ Asked For")
              (discrete-histogram
               '(#(Vanguard-of-War 123) #(Era-of-Kingdoms 8.5) #(Reign-Ed.2 21)
                 ...
                 #(Darkness-Incarnate 0) #(Absolutism-Surviving-Dictatorship 3.9) #(STARTROPOLIS 36.9)
                 #(Miremarsh 98.5))
               #:skip 2 #:x-min 1
